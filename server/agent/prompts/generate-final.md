...
3. `mount` must:
   ...
   - Satisfy the playable quality bar (see playable-quality.md).
...
2. `AGENTS.md` and playable quality rules.
3. Runtime APIs under `public/runtime/`.

## First actions

Write files immediately. Do not spend many turns exploring. Literals (speeds, counts, timers) must match the TDD when quantified.
